...
public class LiquidExtTelephony extends IExtTelephony.Stub {
    ...
    private static LiquidExtTelephony sInstance;
    ...
    public static LiquidExtTelephony getInstance(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
        if (sInstance == null) {
            sInstance = new LiquidExtTelephony(context, phones, commandsInterfaces);
        }

        return sInstance;
    }

    private LiquidExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
